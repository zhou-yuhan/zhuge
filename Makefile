...
# To build 'zhuge', we depend on the object files, and link them all into a single executable using the compilation tool
# We use automatic variables to specify the final executable name 'zhuge', using '$@' and the '$^' will hold the names of all the
